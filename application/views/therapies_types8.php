    ...
    <div class="content content-full-width">
        ...
        <div class="column full-width">
            ...
            <div class="column one-fourth">
                <a href="#" title="" class="rounded-img border alignleft"> <img src="<?php echo base_url('assets_/images/therapy/facial.jpg'); ?>" alt="" title="" /> </a>
            </div>

            <div class="column three-fourth last">
                <h1> Anjanam & Aschyothanam </h1>
                <p> (Duration: 20 minutes) </p>
                <p>Anjanam is the application of herbal medicines to the eyes to cure disease and improve eyesight.</p>
                <p>Aschyothanam involves putting herbal eye drops and an eye wash with herbal water. Indicated for removal of styes, blepharitis. </p>
            </div>
            <div class="hr"> </div>
            <div class="column three-fourth">

                <div class="content-right-aligned">
                    <h1> Kavala Graham / Gandusha   </h1>
                    <p> (Duration: 10 to 20 minutes) </p>
                    <p>Oil pulling procedure - you swish and hold a raw, edible oil (generally coconut oil) in the mouth. </p>
                    <p>Greatly beneficial for oral health, fixing loose teeth, stopping sensitivity, preventing tooth decay & treating bleeding gums.  </p>
                </div>
            </div>
            <div class="column one-fourth last">
                <a href="#" title="" class="rounded-img border alignright"> <img src="<?php echo base_url('assets_/images/therapy/services-detox.jpg'); ?>" alt="" title="" /> </a>
