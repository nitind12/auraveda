    ...
    <div class="content content-full-width">
        ...
        <div class="column full-width">
            ...
            <div class="column three-fourth last">
                <h1> Kizhi (Ela/Podi/Naranga) </h1>
                <p> (Duration: 30 minutes or 60 minutes)</p>
                <p>Fresh leaves/lemon, herbal powders and lentils mixed with coconut and rock salt are fried in oil to prepare hot compresses. Our therapists dip the bags in hot oil and massage gently to wipe out your pains and aches.</p> 
                <p>This is very good for relieving spasm and stiffness of muscles,  joint pain and  backache. The ingredients of Kizhi — turmeric, boiled eggs, lemon, and sand etc. modify the efficacy of the therapy. </p>
            </div>
            <div class="hr"> </div>
            <div class="column three-fourth">
                ...
                <div class="content-right-aligned">
                    ...
                    <p>Therapy with Ayurvedic oils is done in the first phase of this treatment. </p>
                    <p>This is followed by a massage therapy with rice (medicinal rice - Navara) bags dipped in warm milk and herbal decoction [decoction of Sida (bala)roots]</p>
                    <p>This treatment nourishes tissues, strengthens muscles and cures the stiffness of the joints.</p>
 </p>
                </div>
            </div>
